...
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/ID/Sign_extend
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/ID/register_array
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/ID/Instruction_immediate_value
...
add wave -noupdate -group Execute -radix hexadecimal /mips_tb/U_0/EXE/Branch_Add
add wave -noupdate -group Execute /mips_tb/U_0/EXE/Zero
...
WaveRestoreCursors {{Cursor 1} {774690 ps} 0}
...
update
WaveRestoreZoom {50234 ps} {1054925 ps}
