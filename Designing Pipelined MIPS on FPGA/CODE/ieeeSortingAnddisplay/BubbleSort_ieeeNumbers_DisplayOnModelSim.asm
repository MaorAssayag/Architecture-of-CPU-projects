	.data 
Array:      .word     0x433e0000,0x43480000,0x43340000,0x43200000,0xc3160000,0x432a0000,0x430c0000,0xc3020000 # vector size is 8 numbers
	.text
main:
    addi $t0, $0, 28      # 4 bytes per int * 10 ints = 32 bytes   , 28 to 32 is the last place                          
